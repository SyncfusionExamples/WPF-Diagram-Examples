...
The SymbolSource property is the type of object and it notifies the Stencil only new collection is assigned. It does not monitor add or remove and any modification in the assigned collection. The stencil will get refreshed when a new collection is assigned with the SymbolSource property in [WPF Diagram](https://www.syncfusion.com/diagram-sdk/wpf-diagram) (SfDiagram).
