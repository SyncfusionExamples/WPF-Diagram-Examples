...
This repository contains sample which shows how to add node as a child of the Container using the context menu. Explore more details about the WPF Diagram control refer to the following URL : [WPF Diagram](https://www.syncfusion.com/diagram-sdk/wpf-diagram)
