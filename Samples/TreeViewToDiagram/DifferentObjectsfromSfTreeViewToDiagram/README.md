...
This sample demonstrates how to drag and drop different shaped objects from SfTreeView element to [WPF Diagram](https://www.syncfusion.com/diagram-sdk/wpf-diagram) (SfDiagram).

[WPF Diagram](https://www.syncfusion.com/diagram-sdk/wpf-diagram) (SfDiagram) supports dragging and dropping the objects (unknown) from another item's control (apart from stencil). The DragEnter event is used to achieve this drag and drop by changing the unknown object to a known object that is predefined diagram types.
